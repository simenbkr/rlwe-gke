...
t1 = Affine2D().translate(-0.15, 0.0) + ax.transData
t2 = Affine2D().translate(+0.15, 0.0) + ax.transData
...
#plt.errorbar(x, y, e, linestyle='None',marker='^', capsize=2, color="black", label="FALCON-AponGKE")
#-----------------------------------------
...
#plt.errorbar(x, y, e, linestyle='None',marker='^', capsize=2, label="FALCON-ChoiGKE")
...
ax.errorbar(x, y, e, linestyle='None',marker='^', capsize=2, label="qTESLA-AponGAKE", transform=t1)
#--------------------------------
...
ax.errorbar(x, y, e, linestyle='None',marker='^', capsize=2, label="qTESLA-ChoiGAKE", transform=t2)
#--------------------------------
...
fig.savefig("gake-graph.pdf", bbox_inches='tight')
